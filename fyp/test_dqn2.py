...
class DeepQLearningAgent:
    ...
    def __init__(self, env):
        ...
        # self.model.add(Dense(512, input_dim=self.NUM_STATE_ACTION, activation='relu'))  # ROW_SIZE*COL_SIZE*2+1 (first 2 layers and action)
        ...
        self.model = load_model('trained_models/8x8_dqn2.h5')
    ...
    def save_model(self):
        self.model.save('trained_models/8x8_dqn2_test1.h5')
